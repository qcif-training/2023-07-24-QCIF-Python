...
instructor: ["Joseph Clokey","Erin Graham"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Richard Young", "Marlies Hankel", "Pauline Lawrey"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
humanitix: "introduction-to-programming-plotting-and-programming-in-python-240723"         # optional: alphanumeric key for Humanitix registration, e.g., "introduction-to-programming-plotting-and-programming-in-python-200323"
---
